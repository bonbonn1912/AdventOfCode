...
public class Part2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(createFirstNumber(number1List, toBeRemoved1) * createSecondNumber(number2List, toBeRemoved2));
    }

    public static int createFirstNumber(LinkedList<String> inputList1, LinkedList<String> toBeRemoved1) {
        int i = 0;
    ...
    public static int createSecondNumber(LinkedList<String> inputList2, LinkedList<String> toBeRemoved2) {
        int i = 0;
        while (inputList2.size() != 1) {
            char LessCommonBit = createLessCommonBit(inputList2, i);
            createUselessInputs(inputList2, LessCommonBit, i, toBeRemoved2);
            removeEntries(inputList2, toBeRemoved2);
            i++;
        }

        int decimal = 0;
        for (String rest : inputList2) {
            decimal = Integer.parseInt(rest, 2);
        }
        return decimal;
    }
